...
public class HttpClientDemo {
    ...
    public void doGetTestWayOne() {
        ...
        try {
            ...
            params.append("name=" + URLEncoder.encode("admin", "utf-8"));
            params.append("&");
        ...
        // 创建Get请求
        HttpGet httpGet = new HttpGet("http://localhost:9103/httpClient/doGetControllerTwo.do" + "?" + params);
        // 响应模型
        CloseableHttpResponse response = null;
        try {
            // 配置信息
    ...
    public void doGetTestWayTwo() {
        ...
        try {
            ...
            uri = new URIBuilder().setScheme("http").setHost("localhost")
                    .setPort(9103).setPath("/httpClient/doGetControllerTwo.do")
    ...
    public void doPostTestOne() {
        ...
        // 创建Post请求
        HttpPost httpPost = new HttpPost("http://localhost:9103/httpClient/doPostControllerOne.do");
        // 响应模型
        CloseableHttpResponse response = null;
        try {
            // 由客户端执行(发送)Post请求
    ...
    public void doPostTestFour(){
        //获取http客户端(可以理解为：你得现有一个浏览器；注意：实际上HttpCLient与浏览器是不一样的)
        CloseableHttpClient httpClient = HttpClientBuilder.create().build();
        ...
        //创建post请求
        HttpPost httpPost = new HttpPost("http://localhost:9103/httpClient/doPostControllerFour.do?"+params);
    ...
    public void doPostTestTwo() {
        ...
        // 创建Post请求
        HttpPost httpPost = new HttpPost("http://localhost:9103/httpClient/doPostControllerTwo.do");
        User user = new User();
        user.setName("潘晓婷");
        user.setAge(18);
        user.setGender("女");
    ...
    public void doPostTestThree() {
        ...
        try {
            ...
            // 设置uri信息,并将参数集合放入uri;
            // 注:这里也支持一个键值对一个键值对地往里面放setParameter(String key, String value)
            uri = new URIBuilder().setScheme("http").setHost("localhost").setPort(9103)
                    .setPath("/httpClient/doPostControllerThree.do").setParameters(params).build();
        } catch (URISyntaxException e1) {
            e1.printStackTrace();
        }
